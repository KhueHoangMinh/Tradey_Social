...
async function run() {
    ...
    // app.post('/getpostbypostid', async (req,res) => {
    ...
    // app.post('/getcommentbycommentid', async (req,res) => {
    ...
    // app.post('/getshares', async (req,res) => {
    //     const postId = req.body.id
    //     var shares = 0
    ...
    // app.post('/postproduct', marketUpload.single('image'), async (req,res) => {
    ...
    // app.post('/getproductbysellerid', async (req,res) => {
    //     const userId = req.body.userId
    ...
    // app.post('/postadvertisement', advertisementUpload.single('image'), async (req,res) => {
    //     const name = req.body.name
    //     const description = req.body.description
    ...
    // app.post('/getadvertisement', async (req,res) => {
    ...
    // app.post("/changecartquant", async  (req,res) => {
    //     const userId = req.body.userId
    //     const productId = req.body.productId
    //     const action = req.body.action
    ...
    // app.post('/getshopbills', async (req,res) => {
    //     var finalRs = []
    ...
    // app.post('/getbillsbyuser', async (req,res) => {
    //     const userId = req.body.userId
    //     var finalRs = []
    ...
    // app.post('/getbillbybillid', async (req,res) => {
    ...
    // app.post('/updateproduct', updateMarketUpload.single('image'), async (req,res) => {
    //     const name = req.body.name
    //     const description = req.body.description
    //     const price = req.body.price
    //     var image = ''
    ...
    // app.post('/updateuserinfo', userUpload.single('avatar'),async (req,res)=>{
    //     const userId = req.body.userId
    //     var avatar = null
    //     if(req.file) {
    ...
    // app.post('/gethighlighted', async (req,res) => {
    ...
    // app.post('/checkrelationship', async (req,res) => {
    //     const userId = req.body.userId
    //     const friendId = req.body.friendId
